...
class SpotController extends Controller
{
    ...
    public function add(Request $request){
        ...
        $spot_rate = !empty($data['spot_rate']) ? $data['spot_rate'] : '';          //城市id
        $spot_traffic = !empty($data['spot_traffic']) ? $data['spot_traffic'] : '';          //城市id
        $spot_city = !empty($data['spot_city']) ? $data['spot_city'] : '';          //城市id
        if (empty($name)) {
        ...
        }elseif (empty($spot_traffic)) {
            return $this->getBack('0', 'spot_traffic', '');
        } elseif (empty($spot_city)) {
            return $this->getBack('0', 'spot_city', '');
        }
        ...
        $data=[
            ...
            'spot_rate' => $spot_rate,
            'spot_traffic' => $spot_traffic,
            'spot_city' => $spot_city,
        ];


        $result = SpotModel::insertGetId($data);
        if($result){
    ...
    public function hotelAdd(Request $request){
        ...
        }elseif (empty($hotel_city)) {
            return $this->getBack('0', 'hotel_city', '');
        }
        ...
        $result = HotelModel::insertGetId($data);
        if($result){
            return $this->getBack('1', '修改成功', '');
        }else{
            return $this->getBack('0', '修改失败', '');
    ...
    public function planeAdd(Request $request){
        $data = $request->post();
        ...
        $result = PlaneModel::insertGetId($data);
        if($result){
            return $this->getBack('1', '修改成功', '');
        }else{
            return $this->getBack('0', '修改失败', '');
